...
export const translations = {
  zh: {
    ...
    'hud.toOuter': '→外环',
    'hud.toInner': '→内环',
    'hud.enterInnerCity': '🏙️ 进入内城',
    'hud.exitInnerCity': '🏙️ 离开内城',
    'hud.highSpeedRail': '🚄 高铁',
    'hud.hsrFree': '🚄 高铁(自营免费)',
  ...
  en: {
    ...
    'hud.toOuter': '→Outer',
    'hud.toInner': '→Inner',
    'hud.enterInnerCity': '🏙️ Enter Inner City',
    'hud.exitInnerCity': '🏙️ Leave Inner City',
    'hud.highSpeedRail': '🚄 HSR',
    'hud.hsrFree': '🚄 HSR (owned)',
